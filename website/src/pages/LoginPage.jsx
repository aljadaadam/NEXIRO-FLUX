          ...
          <form onSubmit={handleSubmit} className="glass p-8 space-y-6">
            ...
            <div className="">
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl glass hover:bg-white/10 transition-all text-sm font-medium text-dark-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
