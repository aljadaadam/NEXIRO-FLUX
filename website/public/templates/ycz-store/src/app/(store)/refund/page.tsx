  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '1.5rem 1rem 3rem' }}>
      ...
      <div style={{ borderRadius: 20, background: `linear-gradient(135deg, ${currentTheme.primary}, ${currentTheme.secondary})`, padding: '2rem', marginBottom: '2rem', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#fff', marginBottom: 8 }}>سياسة الاسترجاع</h1>
      ...
      <div style={{ background: '#fef2f2', borderRadius: 16, padding: '1.25rem', border: '1px solid #fecaca', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div>
            <h3 style={{ fontSize: '0.95rem', fontWeight: 700, color: '#991b1b', marginBottom: 6 }}>⚠️ المنتجات الرقمية غير قابلة للاسترجاع</h3>
      ...
      <div style={{ background: '#fffbeb', borderRadius: 16, padding: '1.25rem', border: '1px solid #fde68a', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div>
            <h3 style={{ fontSize: '0.95rem', fontWeight: 700, color: '#92400e', marginBottom: 6 }}>💰 رصيد المحفظة غير قابل للسحب</h3>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div style={{ background: '#fff', borderRadius: 16, padding: '1.25rem', border: '1px solid #f1f5f9' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 700, color: '#0b1020' }}>متى يمكن الاسترجاع؟</h3>
          </div>
          <ul style={{ fontSize: '0.84rem', color: '#64748b', lineHeight: 2, paddingRight: '1.25rem', margin: 0 }}>
            <li>إذا لم يتم تنفيذ الخدمة أو تسليم المنتج بسبب خطأ تقني من المنصة</li>
            <li>إذا تم خصم المبلغ أكثر من مرة بسبب خطأ في بوابة الدفع (الخصم المكرر فقط)</li>
            <li>إذا كانت الخدمة المقدمة مختلفة تماماً عن الوصف المعروض</li>
          </ul>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '1.25rem', border: '1px solid #f1f5f9' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 700, color: '#0b1020' }}>حالات لا يتم فيها الاسترجاع</h3>
          </div>
          <ul style={{ fontSize: '0.84rem', color: '#64748b', lineHeight: 2, paddingRight: '1.25rem', margin: 0 }}>
            <li>بعد تنفيذ الخدمة بنجاح وتسليم النتيجة</li>
            <li>تغيير رأي العميل بعد الشراء</li>
            <li>رصيد المحفظة المشحون — لا يمكن سحبه إلى البنك</li>
            <li>عدم قراءة وصف الخدمة أو المنتج قبل الشراء</li>
          </ul>
        </div>
      </div>
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: '1.25rem', border: '1px solid #f1f5f9', marginTop: 16, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '0.82rem', color: '#64748b' }}>لأي استفسارات حول سياسة الاسترجاع، تواصل معنا عبر صفحة الدعم.</p>
