    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: 16 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
            <Share2 size={18} color="#7c5cff" />
            <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#0b1020' }}>روابط التواصل الاجتماعي</h3>
          </div>
            ...
            <div key={s.key} style={{ marginBottom: 12 }}>
              ...
              <input
                ...
                style={{
                  ...
                  background: '#f8fafc', color: '#0b1020', boxSizing: 'border-box',
                }}
              />
            </div>
          ))}
