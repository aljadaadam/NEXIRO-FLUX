...
const fallbackProducts = [
  ...
  { id: 2, name: 'شحن PUBG 660 UC', category: 'ألعاب', price: 18000, image: '/images/default-product.svg' },
  { id: 3, name: 'اشتراك beIN شهري', category: 'beIN Sports', price: 45000, image: '/images/default-product.svg' },
  { id: 4, name: 'تفعيل أوفيس 365', category: 'تفعيلات', price: 35000, image: '/images/default-product.svg' },
  { id: 5, name: 'نتفلكس شهر', category: 'اشتراكات', price: 12000, image: '/images/default-product.svg' },
  { id: 6, name: 'بطاقة PlayStation $10', category: 'ألعاب', price: 22000, image: '/images/default-product.svg' },
  { id: 7, name: 'سبوتيفاي بريميوم', category: 'اشتراكات', price: 8000, image: '/images/default-product.svg' },
  { id: 8, name: 'شحن فري فاير 1080 جوهرة', category: 'ألعاب', price: 15000, image: '/images/default-product.svg' },
];
